...
import {contactFunctions} from './CAFunction'
...
class CA extends Component {
  ...
  constructor(){
    ...
    this.state={
		  ...
		  {question:"What's your College Name ?", pattern: /^.{2,140}$/},
		  {question:"Why do you want to become our Campus Ambassador?", pattern: /^[^*`~<>]{10,1500}$/}
	    ],
	    gotData: false,
	    responseMessage: '',
	    receivedError: false,
