    ...
    transporter.verify(function(error, success) {
	   if (error) {
	        ...
	        let mailOptions = {
		        ...
		        text: 'Hey '+sname+', We received a request for registration in Infotsav 19 with email '+semail+'. Your account has been activated and you can login using the following credentials: <br />Email: '+semail+'<br />Password: '+seyeFID+'<br /> You must login to complete pending payments.<br /> Team Infotsav', // plain text body
...
// const handleEventReg = (req, res, db, xss, email, ifid, eid) =>{
// 	const xssOptions = {
// 		whiteList: [],
// 		stripIgnoreTag: [],
// 		stripIgnoreTagBody: ['script']
